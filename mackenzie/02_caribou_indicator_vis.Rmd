...
```{r SPY75 landscape unit disturbance map 2020, warning = F, message = F, echo = F}
# build map
ggplot (data = sf.lu) +
        geom_sf (aes (fill = perc_disturb_2020)) +
        geom_sf (data = sf.caribou.herds, fill = NA, linetype = "longdash", size = 1.1, colour = "green") +
       # geom_sf_label(data = sf.caribou.herds, aes(label = CARIBOU_TA)) +
        xlab("Longitude") + ylab("Latitude") +
        ggtitle ("SPY75 Disturbance by Landscape Unit in 2020") +
        scale_fill_viridis (option="inferno") +
        guides (fill = guide_legend (title = "Percent of Landscape Unit Disturbed")) +
        annotation_scale(location = "bl", width_hint = 0.5) +
        annotation_north_arrow(location = "bl", which_north = "true", 
...
```{r SPY75 landscape unit disturbance map 2030, warning = F, message = F, echo = F}
# load data
...
ggplot (data = sf.lu.iaf) +
       ...
       # geom_sf_label(data = sf.caribou.herds, aes(label = CARIBOU_TA)) +
        xlab("Longitude") + ylab("Latitude") +
        ggtitle ("SPY75 Disturbance by Landscape Unit in 2030") +
        scale_fill_viridis (option="inferno") +
        guides (fill = guide_legend (title = "Percent of Landscape Unit Disturbed")) +
        annotation_scale(location = "bl", width_hint = 0.5) +
        annotation_north_arrow(location = "bl", which_north = "true", 
...
```{r SPY75 landscape unit disturbance map 2040, warning = F, message = F, echo = F}
# build map
ggplot (data = sf.lu.iaf) +
        geom_sf (aes (fill = perc_disturb_2040)) +
        geom_sf (data = sf.caribou.herds, fill = NA, linetype = "longdash", size = 1.1, colour = "green") +
       # geom_sf_label(data = sf.caribou.herds, aes(label = CARIBOU_TA)) +
        xlab("Longitude") + ylab("Latitude") +
        ggtitle ("SPY75 Disturbance by Landscape Unit in 2040") +
        scale_fill_viridis (option="inferno") +
        guides (fill = guide_legend (title = "Percent of Landscape Unit Disturbed"))  +
        annotation_scale(location = "bl", width_hint = 0.5) +
        annotation_north_arrow(location = "bl", which_north = "true", 
...
```{r SPY75 landscape unit disturbance map 2060, warning = F, message = F, echo = F}
# build map
ggplot (data = sf.lu.iaf) +
        geom_sf (aes (fill = perc_disturb_2060)) +
        geom_sf (data = sf.caribou.herds, fill = NA, linetype = "longdash", size = 1.1, colour = "green") +
       # geom_sf_label(data = sf.caribou.herds, aes(label = CARIBOU_TA)) +
        xlab("Longitude") + ylab("Latitude") +
        ggtitle ("SPY75 Disturbance by Landscape Unit in 2060") +
        scale_fill_viridis (option="inferno") +
        guides (fill = guide_legend (title = "Percent of Landscape Unit Disturbed")) +
        annotation_scale(location = "bl", width_hint = 0.5) +
        annotation_north_arrow(location = "bl", which_north = "true", 
...
```{r SPY75 landscape unit disturbance map 2080, warning = F, message = F, echo = F}
# build map
ggplot (data = sf.lu.iaf) +
        geom_sf (aes (fill = perc_disturb_2060)) +
        geom_sf (data = sf.caribou.herds, fill = NA, linetype = "longdash", size = 1.1, colour = "green") +
       # geom_sf_label(data = sf.caribou.herds, aes(label = CARIBOU_TA)) +
        xlab("Longitude") + ylab("Latitude") +
        ggtitle ("SPY75 Disturbance by Landscape Unit in 2080") +
        scale_fill_viridis (option="inferno") +
        guides (fill = guide_legend (title = "Percent of Landscape Unit Disturbed")) +
        annotation_scale(location = "bl", width_hint = 0.5) +
        annotation_north_arrow(location = "bl", which_north = "true", 
...
```{r SPY75 landscape unit disturbance map difference 2020-2090, warning = F, message = F, echo = F}
...
ggplot (data = sf.lu.iaf) +
       ...
       # geom_sf_label(data = sf.caribou.herds, aes(label = CARIBOU_TA)) +
        xlab("Longitude") + ylab("Latitude") +
        ggtitle ("SPY75 Disturbance Change by Landscape Unit from 2020 to 2090") +
        scale_fill_viridis (option="inferno") +
        guides (fill = guide_legend (title = "Percent Change of Landscape Unit Disturbed")) +
        annotation_scale(location = "bl", width_hint = 0.5) +
        annotation_north_arrow(location = "bl", which_north = "true", 
...
```{r SPY75 watershed disturbance map 2020, warning = F, message = F, echo = F}
# load data
...
ggplot (data = sf.awa.iaf) +
       ...
       # geom_sf_label(data = sf.caribou.herds, aes(label = CARIBOU_TA)) +
        xlab("Longitude") + ylab("Latitude") +
        ggtitle ("SPY75 Disturbance by Watershed Area in 2020") +
        scale_fill_viridis (option="inferno") +
        guides (fill = guide_legend (title = "Percent of Watershed Area Disturbed")) +
        annotation_scale(location = "bl", width_hint = 0.5) +
        annotation_north_arrow(location = "bl", which_north = "true", 
...
```{r SPY75 watershed disturbance map 2030, warning = F, message = F, echo = F}
# build map
ggplot (data = sf.awa.iaf) +
        geom_sf (aes (fill = perc_disturb_2030), color = NA) +
        geom_sf (data = sf.caribou.herds, fill = NA, linetype = "longdash", size = 1.1, colour = "green")+
       # geom_sf_label(data = sf.caribou.herds, aes(label = CARIBOU_TA)) +
        xlab("Longitude") + ylab("Latitude") +
        ggtitle ("SPY75 Disturbance by Watershed Area in 2030") +
        scale_fill_viridis (option="inferno") +
        guides (fill = guide_legend (title = "Percent of Watershed Area Disturbed")) +
        annotation_scale(location = "bl", width_hint = 0.5) +
        annotation_north_arrow(location = "bl", which_north = "true", 
...
```{r SPY75 watershed disturbance map 2040, warning = F, message = F, echo = F}
# build map
ggplot (data = sf.awa.iaf) +
        geom_sf (aes (fill = perc_disturb_2040), color = NA) +
        geom_sf (data = sf.caribou.herds, fill = NA, linetype = "longdash", size = 1.1, colour = "green")+
       # geom_sf_label(data = sf.caribou.herds, aes(label = CARIBOU_TA)) +
        xlab("Longitude") + ylab("Latitude") +
        ggtitle ("SPY75 Disturbance by Watershed Area in 2040") +
        scale_fill_viridis (option="inferno") +
        guides (fill = guide_legend (title = "Percent of Watershed Area Disturbed")) +
        annotation_scale(location = "bl", width_hint = 0.5) +
        annotation_north_arrow(location = "bl", which_north = "true", 
...
```{r SPY75 watershed disturbance map 2060, warning = F, message = F, echo = F}
# build map
ggplot (data = sf.awa.iaf) +
        geom_sf (aes (fill = perc_disturb_2060), color = NA) +
        geom_sf (data = sf.caribou.herds, fill = NA, linetype = "longdash", size = 1.1, colour = "green")+
       # geom_sf_label(data = sf.caribou.herds, aes(label = CARIBOU_TA)) +
        xlab("Longitude") + ylab("Latitude") +
        ggtitle ("SPY75 Disturbance by Watershed Area in 2060") +
        scale_fill_viridis (option="inferno") +
        guides (fill = guide_legend (title = "Percent of Watershed Area Disturbed")) +
        annotation_scale(location = "bl", width_hint = 0.5) +
        annotation_north_arrow(location = "bl", which_north = "true", 
...
```{r SPY75 watershed disturbance map 2080, warning = F, message = F, echo = F}
# build map
ggplot (data = sf.awa.iaf) +
        geom_sf (aes (fill = perc_disturb_2080), color = NA) +
        geom_sf (data = sf.caribou.herds, fill = NA, linetype = "longdash", size = 1.1, colour = "green")+
       # geom_sf_label(data = sf.caribou.herds, aes(label = CARIBOU_TA)) +
        xlab("Longitude") + ylab("Latitude") +
        ggtitle ("SPY75 Disturbance by Watershed Area in 2080") +
        scale_fill_viridis (option="inferno") +
        guides (fill = guide_legend (title = "Percent of Watershed Area Disturbed")) +
        annotation_scale(location = "bl", width_hint = 0.5) +
        annotation_north_arrow(location = "bl", which_north = "true", 
...
```{r SPY75 watershed disturbance map difference 2020-2090, warning = F, message = F, echo = F}
...
ggplot (data = sf.awa.iaf) +
       ...
       # geom_sf_label(data = sf.caribou.herds, aes(label = CARIBOU_TA)) +
        xlab("Longitude") + ylab("Latitude") +
        ggtitle ("SPY75 Disturbance Change by Watershed Area from 2020 to 2090") +
        scale_fill_viridis (option="inferno") +
        guides (fill = guide_legend (title = "Percent Change of Watershed Area Disturbed")) +
        annotation_scale(location = "bl", width_hint = 0.5) +
        annotation_north_arrow(location = "bl", which_north = "true", 
...
```{r SPY75 disturbance by critical habitat central group, warning = F, message = F, echo = F}
...
ggplot (data = crithab.plot.data.cnt.iaf, 
        ...
        scale_x_continuous (limits = c (2020, 2090), breaks = seq (2020, 2090, by = 10)) +
        scale_y_continuous (limits = c (0, 100), breaks = seq (0, 100, by = 10)) +
        ggtitle ("SPY75 Central Group Caribou Critical Habitat Simulated
Disturbance") +
        theme (axis.text = element_text (size = 10),
               axis.title = element_text (size = 12),
               axis.line.x = element_line (size = 1),
...
```{r SPY75 disturbance by critical habitat Graham, warning = F, message = F, echo = F}
...
ggplot (data = crithab.plot.data.grh.iaf, 
        ...
        scale_x_continuous (limits = c (2020, 2090), breaks = seq (2020, 2090, by = 10)) +
        scale_y_continuous (limits = c (0, 100), breaks = seq (0, 100, by = 10)) +
        ggtitle ("SPY75 Graham Caribou Critical Habitat Simulated Disturbance") +
        theme (axis.text = element_text (size = 10),
               axis.title = element_text (size = 12),
               axis.line.x = element_line (size = 1),
               axis.line.y = element_line (size = 1),
...
```{r SPY75 disturbance high elevation north, warning = F, message = F, echo = F}
...
ggplot (data = herd.hi.elev.plot.data.nrth.iaf, 
        ...
        scale_x_continuous (limits = c (2020, 2090), breaks = seq (2020, 2090, by = 10)) +
        scale_y_continuous (limits = c (0, 100), breaks = seq (0, 100, by = 10)) +
        ggtitle ("SPY75 Northern Caribou Range Simulated Disturbance at 
High Elevation (>1,300m)") +
        theme (axis.text = element_text (size = 10),
               axis.title = element_text (size = 12),
               axis.line.x = element_line (size = 1),
...
```{r SPY75 disturbance low elevation north, warning = F, message = F, echo = F}
